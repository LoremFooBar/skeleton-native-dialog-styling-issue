...
<script lang="ts">
	import TestDialogComponent from '$lib/TestDialogComponent.svelte';
...
<div class="container h-full mx-auto flex justify-center items-center">
	<div class="space-y-10 text-center flex flex-col items-center">
		<button class="btn variant-ghost-primary" on:click={()=>dialogElement.showModal()}>Open dialog with token backdrop
		</button>
		<button class="btn variant-ghost-primary" on:click={()=>dialogElement2.showModal()}>Open dialog with regular bg color
			backdrop
		</button>
